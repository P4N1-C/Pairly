...
import { executeCode } from "../lib/submit";
...
function SessionPage() {
  ...
  // auto join the session if user is not already a participant or the host
  useEffect(() => {
  ...
  // redirect participant to the dashboard
  useEffect(() => {
  ...
  const handleEndSession = () => {
    if (
      ...
      //  host is redirected to the dashboard
    ...
    <div className="h-screen bg-base-100 flex flex-col">
      ...
      <div className="flex-1">
        <PanelGroup direction="horizontal">
          ...
          <PanelResizeHandle className="w-1 bg-base-200 hover:bg-primary transition-colors cursor-col-resize" />
          {/* Right Panel for Video and Chat */}
          <Panel defaultSize={50} minSize={30}>
