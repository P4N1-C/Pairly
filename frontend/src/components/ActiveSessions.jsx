      ...
      <div className="card-body">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-gradient-to-br from-neutral/20 to-neutral rounded-xl">
        ...
        <div className="space-y-3 max-h-[400px] overflow-y-auto pr-2">
          {isLoading ? (
              ...
              >
                <div className="flex items-center justify-between gap-4 p-5">
                  <div className="flex items-center gap-4 flex-1">
                    <div className="relative size-14 rounded-xl bg-gradient-to-br from-neutral/20 to-neutral flex items-center justify-center">
            ...
            <div className="text-center py-16">
              <div className="w-20 h-20 mx-auto mb-4 bg-gradient-to-br from-neutral/20 to-secondary/20 rounded-3xl flex items-center justify-center">
